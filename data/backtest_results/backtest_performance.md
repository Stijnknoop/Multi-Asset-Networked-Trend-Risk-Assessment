...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 19
...
* **👑 GOLD Spot:** 3 trades executed
* **🛢️ OIL_CRUDE Spot:** 16 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -0.5145% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +0.5145% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +0.514%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
