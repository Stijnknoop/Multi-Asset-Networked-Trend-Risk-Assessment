...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 161
...
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -6.5997% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +6.5997% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +6.600%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
