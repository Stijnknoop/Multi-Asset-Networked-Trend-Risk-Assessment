...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 109
...
* **🛢️ OIL_CRUDE Spot:** 82 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -4.1229% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +4.1229% | 🟢 Positive Horizon |
