...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 126
...
* **🛢️ OIL_CRUDE Spot:** 96 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -4.0554% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +4.0554% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +4.055%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
