...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 187
...
* **🛢️ OIL_CRUDE Spot:** 134 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -5.9141% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +5.9141% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +5.914%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
