...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 172
...
* **🛢️ OIL_CRUDE Spot:** 123 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -7.1894% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +7.1894% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +7.189%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
