...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 25
...
* **👑 GOLD Spot:** 7 trades executed
* **🛢️ OIL_CRUDE Spot:** 18 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -0.4818% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +0.4818% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +0.482%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
