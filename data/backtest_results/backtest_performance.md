...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 39
...
* **🛢️ OIL_CRUDE Spot:** 30 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -2.8926% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +2.8926% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +2.893%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
