...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 45
...
* **🛢️ OIL_CRUDE Spot:** 36 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -4.1006% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +4.1006% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +4.101%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
