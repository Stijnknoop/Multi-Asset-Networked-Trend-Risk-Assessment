...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 191
...
* **👑 GOLD Spot:** 41 trades executed
* **🛢️ OIL_CRUDE Spot:** 138 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -6.7723% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +6.7723% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +6.772%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
