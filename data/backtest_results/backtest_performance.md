...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 140
...
* **👑 GOLD Spot:** 32 trades executed
* **🛢️ OIL_CRUDE Spot:** 102 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.2614% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.2614% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.261%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
