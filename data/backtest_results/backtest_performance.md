...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 164
...
* **🇺🇸 US500 (S&P 500 Index):** 10 trades executed
* **👑 GOLD Spot:** 38 trades executed
* **🛢️ OIL_CRUDE Spot:** 116 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -7.0223% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +7.0223% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +7.022%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
