...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 89
...
* **🛢️ OIL_CRUDE Spot:** 68 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.2011% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.2011% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.201%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
