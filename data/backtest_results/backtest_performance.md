...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 138
...
* **👑 GOLD Spot:** 31 trades executed
* **🛢️ OIL_CRUDE Spot:** 101 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -2.8937% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +2.8937% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +2.894%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
