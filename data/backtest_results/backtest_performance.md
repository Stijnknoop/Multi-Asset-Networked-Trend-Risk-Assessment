...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 95
...
* **👑 GOLD Spot:** 18 trades executed
* **🛢️ OIL_CRUDE Spot:** 73 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.4031% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.4031% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.403%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
