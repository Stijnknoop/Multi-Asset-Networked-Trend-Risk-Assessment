...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 145
...
* **🇺🇸 US500 (S&P 500 Index):** 7 trades executed
* **👑 GOLD Spot:** 33 trades executed
* **🛢️ OIL_CRUDE Spot:** 105 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.6710% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.6710% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.671%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
