...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 176
...
* **🇺🇸 US500 (S&P 500 Index):** 11 trades executed
* **👑 GOLD Spot:** 39 trades executed
* **🛢️ OIL_CRUDE Spot:** 126 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -6.8393% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +6.8393% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +6.839%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
