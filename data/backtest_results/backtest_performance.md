...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 18
...
* **🛢️ OIL_CRUDE Spot:** 15 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -0.5874% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +0.5874% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +0.587%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
