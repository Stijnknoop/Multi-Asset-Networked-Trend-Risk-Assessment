...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 78
...
* **🛢️ OIL_CRUDE Spot:** 62 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -5.1082% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +5.1082% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +5.108%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
