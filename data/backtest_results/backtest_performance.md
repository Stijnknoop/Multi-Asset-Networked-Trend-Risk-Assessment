...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 155
...
* **🛢️ OIL_CRUDE Spot:** 109 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.5887% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.5887% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.589%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
