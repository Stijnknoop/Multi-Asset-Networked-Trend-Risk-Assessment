...
### 🔬 Pilot Parameters
* **Captured Anomaly Signals (Post-Cooldown):** 115
...
* **🛢️ OIL_CRUDE Spot:** 88 trades executed
    
### 📈 Directional Leaderboard
| Directional Strategy | Total Simulated PnL (%) | Baseline Status |
| :--- | :--- | :--- |
| **🔄 Strategy 1: Mean-Reversion Spread** | -3.9175% | 🔴 Negative Horizon |
| **🚀 Strategy 2: Momentum Breakout** | +3.9175% | 🟢 Positive Horizon |
    
### 🏁 Research Verdict
> **MARKET CHARACTERISTIC:** Following an isolation shock, the asset pricing registry historically favors the **Momentum Breakout** framework (Gross Return: +3.917%). *Note: This baseline pilot model excludes transactional spreads and execution slippage.*
